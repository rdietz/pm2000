...
void show_menu()
{
    ...
    Serial.println(F("3. Set Relay 3 times"));
    Serial.println(F("4. Set Relay 4 times"));
    Serial.println(F("5. Set Pulses per metre"));
    Serial.println(F("6. Set Simulation speed"));
    Serial.println(F("7. Display settings"));
...
void do_Relay3Time()
{
  ...
  {
    Serial.println(F("Save the setting"));
    EEPROM.put(AddrRelay3Delay, input);
  }

  EEPROM.get(AddrRelay3Delay, RELAY3_DELAY);
  Serial.print(F("Relay delay set to : ")); Serial.print(RELAY3_DELAY); Serial.println(F(" mSec \n"));
...
// Get the Operate time
  ...
  {
    Serial.println(F("Save the setting"));
    EEPROM.put(AddrRelay3Time, input);
  }

  EEPROM.get(AddrRelay3Time, RELAY3_PULSE_TIME);
  Serial.print(F("Relay time set to : ")); Serial.print(RELAY3_PULSE_TIME); Serial.println(F(" mSec \n"));
  Serial.println(F("Returning to menu. Please wait. \n"));
...
void do_Relay4Time()
{
  ...
  {
    Serial.println(F("Save the setting"));
    EEPROM.put(AddrRelay4Delay, input);
  }

  EEPROM.get(AddrRelay4Delay, RELAY4_DELAY);
  Serial.print(F("Relay delay set to : ")); Serial.print(RELAY4_DELAY); Serial.println(F(" mSec \n"));
...
// Get the Operate time
  ...
  {
    Serial.println(F("Save the setting"));
    EEPROM.put(AddrRelay4Time, input);
  }

  EEPROM.get(AddrRelay4Time, RELAY4_PULSE_TIME);
  Serial.print(F("Relay time set to : ")); Serial.print(RELAY4_PULSE_TIME); Serial.println(F(" mSec \n"));
  Serial.println(F("Returning to menu. Please wait. \n"));
...
void do_menu()
{
  ...
  if (Serial.available() > 0) 
  {
    ...
    else if (incomingByte == 55)
    {
      ...
      Serial.print(F("Relay 3:    Delay: ")); Serial.print(RELAY3_DELAY); Serial.print(F("mSec  Duration: ")); Serial.print(RELAY3_PULSE_TIME); Serial.println(F(" mSec"));
      Serial.print(F("Relay 4:    Delay: ")); Serial.print(RELAY4_DELAY); Serial.print(F("mSec  Duration: ")); Serial.print(RELAY4_PULSE_TIME); Serial.println(F(" mSec"));
